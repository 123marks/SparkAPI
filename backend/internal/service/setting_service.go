...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	...
	return &PublicSettings{
		...
		SiteName:                         s.getStringOrDefault(settings, SettingKeySiteName, "SparkAPI"),
...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeySiteName:                                  "SparkAPI",
		SettingKeySiteLogo:                                  "",
		SettingKeyPurchaseSubscriptionEnabled:               "false",
		SettingKeyPurchaseSubscriptionURL:                   "",
		SettingKeyTableDefaultPageSize:                      "100",
		SettingKeyTablePageSizeOptions:                      "[20,50,100,200,500,1000]",
		SettingKeyCustomMenuItems:                           "[]",
		SettingKeyCustomEndpoints:                           "[]",
...
func normalizeTablePreferences(defaultPageSize int, options []int) (int, []int) {
	...
	if len(normalizedOptions) == 0 {
		normalizedOptions = []int{20, 50, 100, 200, 500, 1000}
	}
