...
func (s *stubAdminService) ListAccounts(ctx context.Context, page, pageSize int, platform, accountType, status, search string, groupID int64, privacyMode string, createdFrom, createdTo *time.Time, sortBy, sortOrder string) ([]service.Account, int64, error) {
	...
	s.lastListAccounts.createdFrom = createdFrom
	s.lastListAccounts.createdTo = createdTo
