...
export type Platform = 'anthropic' | 'openai' | 'grok' | 'antigravity' | 'gemini' | 'kiro'
...
const BADGE: Record<Platform, string> = {
  ...
  grok: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30 dark:text-cyan-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  grok: 'bg-cyan-500/10 text-cyan-700 dark:bg-cyan-500/10 dark:text-cyan-300',
...
const TEXT: Record<Platform, string> = {
  ...
  grok: 'text-cyan-700 dark:text-cyan-300',
...
const ICON: Record<Platform, string> = {
  ...
  grok: 'text-cyan-600 dark:text-cyan-300',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  grok: 'bg-cyan-100 text-cyan-800 dark:bg-cyan-900/40 dark:text-cyan-200',
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'grok' || p === 'antigravity' || p === 'gemini' || p === 'kiro'
}
