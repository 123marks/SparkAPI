export default {
  ...
  // Setup Wizard
  setup: {
    title: 'SparkAPI Setup',
    description: 'Configure your SparkAPI instance',
    database: {
  ...
  chatConsole: {
    ...
    requestUrlPlaceholder: '/v1/chat/completions',
    requestUrlHint: 'Defaults to this SparkAPI gateway. You can also enter a full OpenAI-compatible URL.',
    apiKey: 'Gateway API Key',
    apiKeyPlaceholder: 'sk-...',
    apiKeyHint: 'Stored only in this browser session. Use a normal SparkAPI key, not the admin password.',
    manualKey: 'Manual key entry',
    savedKeysUnavailable: 'Saved API keys are unavailable. You can enter a key manually.',
    model: 'Model',
    ...
    dropOverlayTitle: 'Drop to attach files',
    dropOverlayDescription: 'Logs, config, JSON, Markdown, and code text are supported.',
    ...
    sending: 'Sending...',
    stop: 'Stop',
    requestCancelled: 'Request stopped. The partial answer was not saved as a completed reply.',
    requestTimedOut: 'Request timed out. Check the gateway, proxy, and upstream account health before retrying.',
    ...
    loadedTools: 'Loaded',
    contextBudget: '{files} files · {tools} capabilities',
    ...
    imageSettings: {
      ...
      hint: 'Uses the OpenAI-compatible images endpoint. GPT image models default to base64; URL, transparent background, moderation, output format, and compression are forwarded or downgraded according to model compatibility. Confirm the selected key has image permission and a priced image-capable group.'
    },
    imageResultAlt: 'Generated image',
    outputMeta: '{chars} chars',
    ...
    activity: {
      ...
      waiting: 'Gateway accepted the request',
      streaming: 'Reading response stream',
      finalizing: 'Finalizing answer',
      imageGenerating: 'Generating image',
      streamingWithChars: 'Streaming · {chars} chars',
      progressLabel: 'Request progress',
      defaultHint: 'The browser is waiting for the gateway to open the upstream request.',
      waitingHint: 'No text has arrived yet. This usually means the upstream model is still thinking or the provider returned a non-streaming response.',
      streamingHint: 'Text is arriving incrementally. The answer is still being normalized and rendered safely.',
      streamingEmptyHint: 'The stream is open, but no text delta has arrived yet.',
      imageHint: 'Image generation can take longer than chat. Keep this tab open while the gateway waits for the upstream task.'
    },
    tools: {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataActions: 'Data',
      toolActions: 'Tools',
      kiroSidecarTitle: 'Kiro-RS Admin',
      kiroSidecarDesc: 'Check the optional Kiro-RS sidecar and open its own account management panel.',
      kiroSidecarChecking: 'Checking Kiro-RS sidecar...',
      kiroSidecarHealthy: 'Kiro-RS is reachable',
      kiroSidecarUnhealthy: 'Kiro-RS needs attention',
      kiroSidecarNotChecked: 'Open or refresh this panel to check sidecar status.',
      kiroSidecarAdminUrl: 'Admin URL',
      kiroSidecarOpenAdmin: 'Open Kiro-RS Admin',
      kiroSidecarSparkBaseUrl: 'SparkAPI account Base URL',
      kiroSidecarBaseUrlHint: 'Use this value in the SparkAPI Anthropic API Key upstream when SparkAPI and Kiro-RS run in the same Docker network.',
      kiroSidecarInternalUrl: 'Container internal URL',
      kiroSidecarApiKeyConfigured: 'Client key configured',
      kiroSidecarLoadFailed: 'Failed to load Kiro-RS sidecar status',
      kiroSidecarModelCount: '{count} models',
      viewColumns: 'Columns',
      selectedCount: '{count} selected',
      ...
      dataImportWarning: 'Import will create new accounts/proxies. You can bind imported accounts to groups before starting.',
      dataImportGroupBindingHint: 'Selected groups are added to every imported account. Existing group IDs in the file are preserved.',
      dataImportSkipDefaultGroup: 'Skip default group binding when no group is selected',
      dataImportSkipDefaultGroupHint: 'Keep imports clean for manual grouping instead of automatically binding defaults.',
      dataImportFile: 'Data file',
      dataImportFileHint: 'Multiple JSON files supported; accepts raw exports, data-field wrappers, or arrays',
      dataImportSelectedFiles: '{count} files selected: {names}',
      dataImportSelectedSize: 'Total size: {size}',
      dataImportFileTooLarge: '{name} is too large. Each file must be {max} or smaller.',
      dataImportTotalTooLarge: 'The selected files are too large. Each import must be {max} or smaller.',
      ...
      createdRangeAll: 'Any created time',
      createdRangeToday: 'Created today',
      createdRange7d: 'Created in 7 days',
      createdRange30d: 'Created in 30 days',
      createdRangeCustom: 'Custom created time',
      ...
      bulkActions: {
        ...
        selectedHint: 'Actions here apply only to checked rows on this page.',
        filteredReady: 'No rows selected',
        filteredHint: 'Use filtered bulk update to apply changes to the current filter result.',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for SparkAPI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for SparkAPI end-user login',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to SparkAPI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">SparkAPI is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of SparkAPI, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to SparkAPI',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the SparkAPI AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
