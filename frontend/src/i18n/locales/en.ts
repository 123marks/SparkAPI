export default {
  ...
  chatConsole: {
    ...
    imageSettings: {
      ...
      hint: 'Uses the OpenAI-compatible images endpoint. GPT image models default to base64; URL, transparent background, output format, and compression are forwarded or downgraded according to model compatibility. Confirm the selected key has image permission and a priced image-capable group.'
    },
  ...
  admin: {
    ...
    accounts: {
      ...
      kiroSidecarApiKeyConfigured: 'API key configured',
