<template>
  ...
  <!-- Grok/xAI logo (compact X mark) -->
  <svg v-else-if="platform === 'grok'" :class="sizeClass" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M4 5l16 14" />
    <path d="M20 5L4 19" />
    <path d="M8 5h8" />
    <path d="M8 19h8" />
